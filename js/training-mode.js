...
export function handleJudge(answer) {
  ...
  if (correct) {
    ...
    if (trainingState.currentQuestionRecord.firstWrongFormulaText === null) {
      trainingState.currentQuestionRecord.firstWrongFormulaText = trainingState.currentQuestionRecord.lastAttemptText;
    }
